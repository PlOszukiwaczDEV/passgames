...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.physics2.objectsCollide(gdjs.LevelsCode.mapOfGDgdjs_9546LevelsCode_9546GDSmallRedBallObjects2Objects, "Physics2", gdjs.LevelsCode.mapOfGDgdjs_9546LevelsCode_9546GDCloudObjects2Objects, false);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9782956);
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = ((( gdjs.LevelsCode.GDFinishObjects2.length === 0 ) ? 0 :gdjs.LevelsCode.GDFinishObjects2[0].getX()) > (( gdjs.LevelsCode.GDSmallRedBallObjects2.length === 0 ) ? 0 :gdjs.LevelsCode.GDSmallRedBallObjects2[0].getPointX("")) + 300);
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("DistanceLeft"), gdjs.LevelsCode.GDDistanceLeftObjects2);
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = ((( gdjs.LevelsCode.GDFinishObjects1.length === 0 ) ? 0 :gdjs.LevelsCode.GDFinishObjects1[0].getX()) < (( gdjs.LevelsCode.GDSmallRedBallObjects1.length === 0 ) ? 0 :gdjs.LevelsCode.GDSmallRedBallObjects1[0].getPointX("")) + 300);
}
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
{gdjs.evtTools.linkedObjects.pickObjectsLinkedTo(runtimeScene, gdjs.LevelsCode.mapOfGDgdjs_9546LevelsCode_9546GDStarObjects3Objects, (gdjs.LevelsCode.GDSmallRedBallObjects3.length !== 0 ? gdjs.LevelsCode.GDSmallRedBallObjects3[0] : null), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
...
{gdjs.evtTools.linkedObjects.pickObjectsLinkedTo(runtimeScene, gdjs.LevelsCode.mapOfGDgdjs_9546LevelsCode_9546GDStarObjects2Objects, (gdjs.LevelsCode.GDSmallRedBallObjects2.length !== 0 ? gdjs.LevelsCode.GDSmallRedBallObjects2[0] : null), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
