...
let isConditionTrue_0 = false;
{
{runtimeScene.getScene().getVariables().get("MaxBalls").setNumber(5);
}{runtimeScene.getScene().getVariables().get("ShootingDelay").setNumber(0.1);
}{runtimeScene.getScene().getVariables().get("BallLaunchForce").setNumber(300);
}{runtimeScene.getScene().getVariables().get("CurrentLevel").setNumber(1);
}{runtimeScene.getScene().getVariables().get("AimingBallQty").setNumber(16);
}{runtimeScene.getScene().getVariables().get("ExtraBallChance").setNumber(0.2);
}{runtimeScene.getScene().getVariables().get("DirectionToShoot").setNumber(gdjs.randomInRange(200, 340));
}}
...
gdjs.Main_32MenuCode.asyncCallback13830468 = function (runtimeScene, asyncObjectsList) {
{runtimeScene.getScene().getVariables().get("BallsLeftToShoot").setNumber(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("MaxBalls")));
}}
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Main_32MenuCode.asyncCallback13830468(runtimeScene, asyncObjectsList)));
}
}
...
}{runtimeScene.getScene().getVariables().get("BallsLeftToShoot").sub(1);
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13830172);
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("BallsLeftToShoot")) > 0;
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14245116);
}
if (isConditionTrue_0) {
...
};gdjs.Main_32MenuCode.mapOfGDgdjs_9546Main_959532MenuCode_9546GDWorldObjects3Objects = Hashtable.newFrom({"World": gdjs.Main_32MenuCode.GDWorldObjects3});
gdjs.Main_32MenuCode.mapOfGDgdjs_9546Main_959532MenuCode_9546GDBlockObjects4Objects = Hashtable.newFrom({"Block": gdjs.Main_32MenuCode.GDBlockObjects4});
gdjs.Main_32MenuCode.asyncCallback13840036 = function (runtimeScene, asyncObjectsList) {
gdjs.copyArray(runtimeScene.getObjects("Block"), gdjs.Main_32MenuCode.GDBlockObjects4);
{gdjs.evtTools.leaderboards.displayLeaderboard(runtimeScene, "a90359f2-836a-4b2a-8d81-5c3e14967347", true);
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.Main_32MenuCode.asyncCallback13840036(runtimeScene, asyncObjectsList)));
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.Main_32MenuCode.mapOfGDgdjs_9546Main_959532MenuCode_9546GDWorldObjects3Objects, runtimeScene, true, false);
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.Main_32MenuCode.GDViewLeaderboards_9595TextObjects3.length ;i < len;++i) {
    gdjs.Main_32MenuCode.GDViewLeaderboards_9595TextObjects3[i].hide(false);
}
}
{ //Subevents
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.Main_32MenuCode.mapOfGDgdjs_9546Main_959532MenuCode_9546GDWorldObjects3Objects, runtimeScene, true, true);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13841820);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("ViewLeaderboards_Text"), gdjs.Main_32MenuCode.GDViewLeaderboards_9595TextObjects3);
{for(var i = 0, len = gdjs.Main_32MenuCode.GDViewLeaderboards_9595TextObjects3.length ;i < len;++i) {
    gdjs.Main_32MenuCode.GDViewLeaderboards_9595TextObjects3[i].hide();
}
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13842348);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Block"), gdjs.Main_32MenuCode.GDBlockObjects2);
...
};gdjs.Main_32MenuCode.mapOfGDgdjs_9546Main_959532MenuCode_9546GDLargePlayButtonObjects1Objects = Hashtable.newFrom({"LargePlayButton": gdjs.Main_32MenuCode.GDLargePlayButtonObjects1});
gdjs.Main_32MenuCode.asyncCallback13844212 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Main_32MenuCode.asyncCallback13844212(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.Main_32MenuCode.mapOfGDgdjs_9546Main_959532MenuCode_9546GDLargePlayButtonObjects1Objects, runtimeScene, true, false);
}
if (isConditionTrue_0) {
