...
};gdjs.TutorialCode.mapOfGDgdjs_9546TutorialCode_9546GDLargePlayButtonObjects2Objects = Hashtable.newFrom({"LargePlayButton": gdjs.TutorialCode.GDLargePlayButtonObjects2});
gdjs.TutorialCode.asyncCallback13913060 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.TutorialCode.asyncCallback13913060(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.TutorialCode.mapOfGDgdjs_9546TutorialCode_9546GDLargePlayButtonObjects2Objects, runtimeScene, true, false);
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("FadeInOut"), gdjs.TutorialCode.GDFadeInOutObjects2);
